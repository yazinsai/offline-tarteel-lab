...
# Variant runtime.adaptive.partial_match_margin.07: margin on the first-match lock bar.
...
def _infer_first_verse(_audio_path: Path) -> tuple[int, int]:
    """Smoke baseline deliberately ignores corpus filenames and sidecar labels."""
    return 1, 1
