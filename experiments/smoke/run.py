...
# Variant runtime.adaptive.smoothing_window.13: default depth one frame deeper than variant 05 (3)
# so windows_until_lock scales by (1 + 0.035 * 4); still metadata-only for tier-2 labels.
