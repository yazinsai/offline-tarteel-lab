...
# Variant runtime.adaptive.smoothing_window.13: one extra integration frame vs variant 05 (default 3) so
# windows_until_lock scales slightly higher via (1 + 0.035 * frames) without changing first-match labels.
