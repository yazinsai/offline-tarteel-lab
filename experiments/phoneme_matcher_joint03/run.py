"""Phoneme CTC beam decode + Quran matcher (joint03).

Like phoneme_matcher_joint02 (multi-hypothesis beam + trigram shortlist), but applies the
fragment-aware Levenshtein head rerank from matcher_asr_path_v02 before span expansion.
Shares committed reference_phoneme_v4/quran_phonemes.json (no duplicate DB).
"""
...
# Fragment blend for head rerank (matcher_asr_path_v02-style); orthogonal to beam decode.
